...
const RouteMap = ({ 
  ...
  useEffect(() => {
    if (!map.current || !pickupCoordinates || !deliveryCoordinates) {
      setRouteInfo(null);
      return;
    }
    ...
    const updateRoute = async () => {
      ...
      try {
        const url = `https://api.mapbox.com/directions/v5/mapbox/driving/${pickupCoordinates.lng},${pickupCoordinates.lat};${deliveryCoordinates.lng},${deliveryCoordinates.lat}?access_token=${MAPBOX_TOKEN}&geometries=geojson&overview=full`;
