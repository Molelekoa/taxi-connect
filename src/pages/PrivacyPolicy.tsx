...
const PrivacyPolicy = () => {
  return (
    <>
      <Helmet>
        <title>Privacy Policy | Dyno Dash</title>
        <meta name="description" content="Dyno Dash Privacy Policy - Learn how we collect, use, and protect your personal information." />
      </Helmet>
            ...
            <div className="prose prose-lg max-w-none text-foreground">
              <section className="mb-10">
                ...
                <p className="text-muted-foreground mb-4">
                  Dyno Dash ("we," "our," or "us") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our freight brokerage services and website.
                </p>
