...
const TermsOfService = () => {
  return (
    <>
      <Helmet>
        <title>Terms of Service | Parcolo</title>
        <meta name="description" content="Parcolo Terms of Service - Read our terms and conditions for using our community-driven delivery services." />
      </Helmet>
            ...
            <div className="prose prose-lg max-w-none text-foreground">
              <section className="mb-10">
                ...
                <p className="text-muted-foreground mb-4">
                  Welcome to Parcolo. These Terms of Service ("Terms") govern your use of our website and community-driven delivery services. By accessing or using our services, you agree to be bound by these Terms and our Privacy Policy.
                </p>
              ...
              <section className="mb-10">
                ...
                <p className="text-muted-foreground mb-4">
                  Parcolo operates as a community-driven delivery network, connecting senders with Traveler Partners who deliver parcels along routes they are already taking. Our services include:
                </p>
                ...
                <p className="text-muted-foreground mt-4">
                  Parcolo facilitates connections between senders and Traveler Partners but does not directly transport goods. Traveler Partners are independent community members who carry parcels on routes they are already traveling.
                </p>
              </section>
              ...
              <section className="mb-10">
                ...
                <ul className="list-disc pl-6 text-muted-foreground space-y-2">
                  ...
                  <li>Parcolo's service fee is deducted from the delivery payment before disbursement to the Traveler Partner</li>
                </ul>
              </section>
              ...
              <section className="mb-10">
                ...
                <ul className="list-disc pl-6 text-muted-foreground space-y-2">
                  ...
                  <li>Parcolo does not offer liability insurance or cargo insurance of any kind</li>
                  <li>We endeavor to vet all members of our community to maintain a trustworthy network</li>
                  <li>In the event of theft, Parcolo will assist by providing all information necessary to file a police report</li>
              ...
              <section className="mb-10">
                ...
                <p className="text-muted-foreground mb-4">
                  Community partners wishing to join Parcolo must:
                </p>
                <ul className="list-disc pl-6 text-muted-foreground space-y-2">
              ...
              <section className="mb-10">
                ...
                <p className="text-muted-foreground">
                  All content on our website, including text, graphics, logos, and software, is the property of Parcolo and is protected by intellectual property laws. You may not reproduce, distribute, or create derivative works without our express written consent.
                </p>
              </section>
              ...
              <section className="mb-10">
                ...
                <p className="text-muted-foreground">
                  You agree to indemnify and hold harmless Parcolo, its officers, directors, employees, and agents from any claims, damages, losses, or expenses arising from your use of our services, violation of these Terms, or infringement of any third-party rights.
                </p>
              </section>
